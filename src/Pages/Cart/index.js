    ...
    const removeItem = (id) => {
        ...
        deleteData(`/api/cart/${id}`).then((res) => {
            context.setAlertBox({
                open: true,
                error: false,
                msg: "mặt hàng đã được xóa khỏi giỏ hàng!"
            })
                                                    ...
                                                    cartData?.length !== 0 && cartData?.map((item, index) => {
                                                        return (
                                                            <tr>
                                                                ...
                                                                <td width="15%"> {item?.price.toLocaleString("vi-VN", {
                                                                    style: "currency",
                                                                    currency: "VND",
                                                                })}</td>
                                                                <td width="25%">
                                                                ...
                                                                <td width="15%"> {item?.subTotal.toLocaleString("vi-VN", {
                                                                    style: "currency",
                                                                    currency: "VND",
                                                                })}</td>
                                            ...
                                            <span className="ml-auto text-red font-weight-bold">
                                                {
                                                    (context.cartData?.length !== 0 ?
                                                        context.cartData?.map(item => parseInt(item.price) * item.quantity).reduce((total, value) => total + value, 0) : 0)?.toLocaleString("vi-VN", {
                                                            style: "currency",
                                                            currency: "VND",
                                                        })
                                                }
